                ...
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle mr-lg-2" id="messagesDropdown" href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        ...
                        <span class="d-lg-none">Pesan
                            <span class="badge badge-pill badge-primary">1 Pesan baru</span>
                        </span>
                    ...
                    <div class="dropdown-menu" aria-labelledby="messagesDropdown">
                        ...
                        <a class="dropdown-item" href="#">
                            <strong>Cak Galih</strong>
                            <span class="small float-right text-muted">11:21 WIB</span>
                            <div class="dropdown-message small">Ada masalah di bagian produksi.</div>
                        </a>
                        <div class="dropdown-divider"></div>
                        <a class="dropdown-item small" href="#">Lihat semua pesan.</a>
                    </div>
                </li>
                <li class="nav-item">
    ...
    <div class="content-wrapper">
        <div class="container-fluid">
            ...
            <div class="card mb-3">
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered" id="dataTable">
                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                        <td><?php echo $key['id']; ?></td> <!-- Menggunakan ID dari database sebagai nomor urutan -->
                                        <td><?php echo $key['nama']; ?></td>
                                        <td><?php echo $key['email']; ?></td>
                                        <td><?php echo $key['telpon']; ?></td>
                                        <td><?php echo $key['isi']; ?></td>
                                        <td><img src="../user/public/<?php echo $key['gambar_path']; ?>" width="100" height="100" alt="Deskripsi Gambar"></td>
                ...
                <div class="card-footer small text-muted">Terakhir diupdate kemarin 10.33 WIB</div>
            </div>
