            ...
            <ul class="navbar-nav navbar-sidenav sidebar-menu" id="exampleAccordion">
                ...
                <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Tables">
                    <a class="nav-link" href="tables">
                        ...
                        <span class="nav-link-text">Tabel Data</span>
                    </a>
                </li>
    ...
    <div class="content-wrapper">
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <div class="col-xl-3 col-sm-6 mb-3">
                    <div class="card text-white bg-danger o-hidden h-100">
                        ...
                        <a class="card-footer text-white clearfix small z-1" href="tables.php">
                            <span class="float-left">Laporan Belum Ditanggapi</span>
                            <span class="float-right">
                                <i class="fa fa-angle-right"></i>
                            </span>
                        </a>
                ...
                <div class="col-xl-3 col-sm-6 mb-3">
                    <div class="card text-white bg-success o-hidden h-100">
                        ...
                        <a class="card-footer text-white clearfix small z-1" href="tables.php">
                            <span class="float-left">Laporan Sudah Ditanggapi</span>
                            <span class="float-right">
                                <i class="fa fa-angle-right"></i>
                            </span>
                        </a>
            ...
            <div class="card mb-3">
                ...
                <div class="card-footer small text-muted">Terakhir diperbarui Kemarin 11:59 WIB</div>
            </div>
        </div>
        <!-- /.container-fluid-->
